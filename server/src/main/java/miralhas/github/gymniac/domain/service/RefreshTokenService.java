...
import miralhas.github.gymniac.domain.exception.RefreshTokenExpiredException;
import miralhas.github.gymniac.domain.exception.RefreshTokenNotFoundException;
import miralhas.github.gymniac.domain.model.auth.RefreshToken;
import miralhas.github.gymniac.domain.model.auth.User;
import miralhas.github.gymniac.domain.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
	...
	private final TokenProperties tokenPropertiesConfig;
	...
	public RefreshToken save(User user) {
		var refreshToken = RefreshToken.builder()
				...
				.plusSeconds(tokenPropertiesConfig.refreshToken().expirationTime()))
				.build();
